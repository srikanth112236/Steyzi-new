/**
 * BACKUP OF AUTH SLICE - CREATED 2025-10-13
 * This is a backup of the current authSlice.js content
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(login.fulfilled, (state, action) => {
        ...
        // Set new onboarding fields
        state.onboardingCompleted = action.payload.onboarding_completed || false;
        state.defaultBranch = action.payload.default_branch || false;
        state.defaultBranchId = action.payload.default_branch_id || null;
        state.pgConfigured = action.payload.pg_configured || false;
