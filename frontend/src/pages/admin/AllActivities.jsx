...
import { Calendar, Filter, RefreshCw, Search, ChevronLeft, ChevronRight, Download, Info, Activity, Shield, HeadphonesIcon, DollarSign, FileText, Building2, Users, Clipboard } from 'lucide-react';
...
const AllActivities = () => {
  ...
  const load = async () => {
    try {
      setLoading(true);
      // Use role-specific activity service based on current user role
