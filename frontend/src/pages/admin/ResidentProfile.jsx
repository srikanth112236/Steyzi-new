              ...
              >
                ...
                <div className="bg-gradient-to-r from-sky-50 to-blue-50 p-6 rounded-xl border border-sky-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="p-3 bg-white rounded-lg border border-sky-200">
                      <span className="text-sm font-medium text-gray-600">Rent Paid</span>
                    ...
                    <div className="p-3 bg-white rounded-lg border border-sky-200">
                      ...
                      <p className="text-2xl font-bold text-gray-900">{resident?.paymentSummary?.totalMonths || 0}</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                    <div className="p-3 bg-white rounded-lg border border-sky-200">
                      <span className="text-sm font-medium text-gray-600">Rent Payments</span>
                      <p className="text-lg font-bold text-blue-600">{resident?.rentPaymentCount || 0}</p>
                    </div>
                    <div className="p-3 bg-white rounded-lg border border-sky-200">
                      <span className="text-sm font-medium text-gray-600">Advance Payments</span>
                      <p className="text-lg font-bold text-purple-600">{resident?.advancePaymentCount || 0}</p>
                    </div>
                    <div className="p-3 bg-white rounded-lg border border-sky-200">
                      <span className="text-sm font-medium text-gray-600">Average Rent</span>
                      <p className="text-lg font-bold text-gray-900">₹{resident?.paymentSummary?.averageRentAmount || 0}</p>
                    </div>
                  </div>
                </div>
