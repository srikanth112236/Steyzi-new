...
/**
 * Generate PDF content for allocation letter (Frontend version)
 */
export async function generateAllocationLetterPDF(allocationData) {
  try {
...
/**
 * Convert HTML to base64 PDF data (Frontend version)
 */
export async function htmlToBase64PDF(htmlContent) {
  try {
